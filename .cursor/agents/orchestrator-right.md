...
**Dispatch Planner** — "Goal: [goal]. Break into epics, dispatch Sub-Planner per epic, create tasks. Stop at 33 tasks, return BATCH_DONE." Planner owns epics + Sub-Planner. You do NOT dispatch Sub-Planner — Planner does. When Planner returns BATCH_DONE → Return BATCH_DONE → Orchestrator hands off to Left.
